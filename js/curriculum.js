...
const CURRICULUM = [
  {
    ...
    days: [
      ...
      { day: 6,  title: "File I/O: Reading & Writing Test Logs",file: "pages/day6.html",  status: "available" },
      { day: 7,  title: "JSON & YAML: Config File Parsing",     file: "pages/day7.html",  status: "available" },
